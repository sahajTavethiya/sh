...
export class StockReportCMComponent implements OnInit {


  constructor(readonly service: StockCMService , readonly authService: AuthService,
...
// });
  ...
  search(){
    ...
    console.log(this.displayArr);
      ...
      this.service.getStockReport(this.searchData).subscribe((response: any) => {
  ...
  addStock(){
    this.routeUrl.navigate(['/StockDetail'])
  }
  reset(){
