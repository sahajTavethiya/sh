...
export class ClientReportComponent implements OnInit {
  ...
  constructor(readonly service: ClientService , readonly authService: AuthService,
...
// });
  ...
  search(){
    ...
    if (this.searchForm.valid) {
     ...
     console.log(this.displayArr);
      ...
      this.service.getClietReport(this.searchData).subscribe((response: any) => {
  ...
  addOrder(){
    this.routeUrl.navigate(['/ClientReportDetail'])
  }
  reset(){
