...
@Component({
  selector: 'app-submit-daily-work',
  templateUrl: './submit-daily-work.component.html',
  styleUrls: ['./submit-daily-work.component.scss']
})
export class SubmitDailyWorkComponent implements OnInit {

  constructor(readonly service: SubmitWorkService , readonly authService: AuthService,
